...
class YtWindow(Gtk.Window):
    ...
    def on_contextMenu(self, treeView, event):
        ...
        if path is not None:
            ...
            box.pack_start(Gtk.Image(icon_name="list-remove"), False, False, 0)
            box.pack_start(Gtk.Label(label=_t("MENU_DEL")), False, False, 0)
            rm.add(box)
            ...
            mopen = Gtk.MenuItem()
            box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
            box.pack_start(Gtk.Image(icon_name="document-open"), False, False, 0)
            box.pack_start(Gtk.Label(label=_t("MENU_OPEN")), False, False, 0)
            mopen.add(box)
            mopen.connect("activate", self.on_open_clicked)
            menu.add(mopen)
            reload = Gtk.MenuItem()
            box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
            box.pack_start(Gtk.Image(icon_name="go-down"), False, False, 0)
            box.pack_start(Gtk.Label(label=_t("MENU_RELOAD")), False, False, 0)
            reload.add(box)
        ...
        rmall = Gtk.MenuItem()
        box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
        box.pack_start(Gtk.Image(icon_name="edit-delete"), False, False, 0)
        box.pack_start(Gtk.Label(label=_t("MENU_DEL_ALL")), False, False, 0)
        rmall.add(box)
